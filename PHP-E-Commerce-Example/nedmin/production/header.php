...
<script src="https://cdn.ckeditor.com/4.14.0/standard/ckeditor.js"></script>
    <title>Aziz Görkem Akpur PHP </title>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="kullanici.php"><i class="fa fa-users" aria-hidden="true"></i> Kullanıcılar </a></li>
                  <li><a href="menu.php"><i class="fa fa-list" aria-hidden="true"></i> Menü </a></li>
                  <li><a href="slider.php"><i class="fa fa-image" aria-hidden="true"></i> Slider </a></li>
